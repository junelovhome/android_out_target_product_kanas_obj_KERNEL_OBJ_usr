...
#define CEIL(x,y)   ({uint32_t __x = (x),__y = (y);(__x + __y -1)/__y;})
    ...
    typedef struct _GSP_REG_T_TAG_
    {
        union _GSP_CFG_TAG //0x0000
        {
            struct _GSP_CFG_MAP
            {
                __volatile__ uint32_t gsp_run               :1;
                __volatile__ uint32_t gsp_busy          :1;
                __volatile__ uint32_t error_flag            :1;
                __volatile__ uint32_t error_code            :5;
                __volatile__ uint32_t dither_en         :1;
                __volatile__ uint32_t pmargb_mod0           :1;
                __volatile__ uint32_t pmargb_mod1           :1;
                __volatile__ uint32_t pmargb_en         :1;
                __volatile__ uint32_t scale_en          :1;
                __volatile__ uint32_t reserved2         :2;
                __volatile__ uint32_t scale_status_clr    :1;
                __volatile__ uint32_t l0_en             :1;
                __volatile__ uint32_t l1_en             :1;
                __volatile__ uint32_t reserved3         :6;
                __volatile__ uint32_t dist_rb           :8;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_cfg_u;
        ...
        union _GSP_INT_CFG_TAG//0x0004
        {
            ...
            {
                __volatile__ uint32_t int_en            :1;
                __volatile__ uint32_t reserved1     :7;
                __volatile__ uint32_t int_mod           :1;
                __volatile__ uint32_t reserved2     :7;
                __volatile__ uint32_t int_clr           :1;
                __volatile__ uint32_t reserved3     :15;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_int_cfg_u;
        ...
        union _GSP_CMD_ADDR_TAG//0x0008
        {
            ...
            {
                __volatile__ uint32_t cmd_base_addr     :32;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_cmd_addr_u;
        ...
        union _GSP_CMD_CFG_TAG//0x000c
        {
            ...
            {
                __volatile__ uint32_t cmd_num           :16;
                __volatile__ uint32_t cmd_en            :1;
                __volatile__ uint32_t reserved1     :7;
                __volatile__ uint32_t cmd_endian_mod    :3;
                __volatile__ uint32_t reserved2     :5;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_cmd_cfg_u;
        ...
        union _GSP_DES_DATA_CFG_TAG//0x0010
        {
            ...
            {
                __volatile__ uint32_t des_img_format    :3;
                __volatile__ uint32_t reserved1     :1;
                __volatile__ uint32_t compress_r8       :1;
                __volatile__ uint32_t reserved2     :27;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_des_data_cfg_u;
        ...
        union _GSP_DES_Y_ADDR_TAG//0x0014
        {
            ...
            {
                __volatile__ uint32_t des_y_base_addr       :32;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_des_y_addr_u;
        ...
        union _GSP_DES_UV_ADDR_TAG//0x0018
        {
            ...
            {
                __volatile__ uint32_t des_uv_base_addr   :32;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_des_uv_addr_u;
        ...
        union _GSP_DES_V_ADDR_TAG//0x001c
        {
            ...
            {
                __volatile__ uint32_t des_v_base_addr        :32;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_des_v_addr_u;
        ...
        union _GSP_DES_PITCH_TAG//0x0020
        {
            ...
            {
                __volatile__ uint32_t des_pitch         :12;
                __volatile__ uint32_t reserved          :20;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_des_pitch_u;
        ...
        union _GSP_DES_DATA_ENDIAN_TAG//0x0024
        {
            ...
            {
                __volatile__ uint32_t y_endian_mod      :3;
                __volatile__ uint32_t uv_endian_mod     :3;
                __volatile__ uint32_t v_endian_mod      :3;
                __volatile__ uint32_t rgb_swap_mod      :3;
                __volatile__ uint32_t a_swap_mod            :1;
                __volatile__ uint32_t reserved_unpred       :19;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_DES_SIZE_TAG//0x0028
        {
            ...
            {
                __volatile__ uint32_t des_size_x_l0     :12;
                __volatile__ uint32_t reserved0         :4;
                __volatile__ uint32_t des_size_y_l0     :12;
                __volatile__ uint32_t reserved1         :4;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_layer0_des_size_u;

        __volatile__ uint32_t resevered0;

        union _GSP_LAYER0_CFG_TAG//0x0030
        {
            struct _GSP_LAYER0_CFG_MAP
            {
                __volatile__ uint32_t img_format_l0     :4;
                __volatile__ uint32_t reserved0         :12;
                __volatile__ uint32_t rot_mod_l0            :3;
                __volatile__ uint32_t ck_en_l0          :1;
                __volatile__ uint32_t pallet_en_l0      :1;
                __volatile__ uint32_t reserved1         :3;
                __volatile__ uint32_t row_tap_mod       :2;
                __volatile__ uint32_t col_tap_mod       :2;
                __volatile__ uint32_t reserved2         :4;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_layer0_cfg_u;
        ...
        union _GSP_LAYER0_Y_ADDR_TAG//0x0034
        {
            ...
            {
                __volatile__ uint32_t y_base_addr_l0        :32;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_layer0_y_addr_u;
        ...
        union _GSP_LAYER0_UV_ADDR_TAG//0x0038
        {
            ...
            {
                __volatile__ uint32_t uv_base_addr_l0       :32;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER0_VA_ADDR_TAG//0x003c
        {
            ...
            {
                __volatile__ uint32_t va_base_addr_l0       :32;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER0_PITCH_TAG//0x0040
        {
            ...
            {
                __volatile__ uint32_t pitch0            :12;
                __volatile__ uint32_t reserved      :20;
            }
            mBits;
        } gsp_layer0_pitch_u;
        ...
        union _GSP_LAYER0_CLIP_START_TAG//0x0044
        {
            ...
            {
                __volatile__ uint32_t clip_start_x_l0       :12;
                __volatile__ uint32_t reserved0         :4;
                __volatile__ uint32_t clip_start_y_l0       :12;
                __volatile__ uint32_t reserved1         :4;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER0_CLIP_SIZE_TAG//0x0048
        {
            ...
            {
                __volatile__ uint32_t clip_size_x_l0        :12;
                __volatile__ uint32_t reserved0         :4;
                __volatile__ uint32_t clip_size_y_l0        :12;
                __volatile__ uint32_t reserved1         :4;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER0_DES_START_TAG//0x004c
        {
            ...
            {
                __volatile__ uint32_t des_start_x_l0        :12;
                __volatile__ uint32_t reserved0         :4;
                __volatile__ uint32_t des_start_y_l0        :12;
                __volatile__ uint32_t reserved1         :4;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER0_GREY_RGB_TAG//0x0050
        {
            ...
            {
                __volatile__ uint32_t layer0_grey_b     :8;
                __volatile__ uint32_t layer0_grey_g     :8;
                __volatile__ uint32_t layer0_grey_r     :8;
                __volatile__ uint32_t reserved          :8;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER0_ENDIAN_TAG//0x0054
        {
            ...
            {
                __volatile__ uint32_t y_endian_mod_l0       :3;
                __volatile__ uint32_t uv_endian_mod_l0  :3;
                __volatile__ uint32_t va_endian_mod_l0  :3;
                __volatile__ uint32_t rgb_swap_mod_l0       :3;
                __volatile__ uint32_t a_swap_mod_l0     :1;
                __volatile__ uint32_t reserved          :19;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_layer0_endian_u;
        ...
        union _GSP_LAYER0_ALPHA_TAG//0x0058
        {
            ...
            {
                __volatile__ uint32_t alpha_l0          :8;
                __volatile__ uint32_t reserved          :24;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_layer0_alpha_u;
        ...
        union _GSP_LAYER0_CK_TAG//0x005c
        {
            ...
            {
                __volatile__ uint32_t ck_b_l0           :8;
                __volatile__ uint32_t ck_g_l0           :8;
                __volatile__ uint32_t ck_r_l0           :8;
                __volatile__ uint32_t reserved      :8;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER1_CFG_TAG//0x0060
        {
            ...
            {
                __volatile__ uint32_t img_format_l1     :4;
                __volatile__ uint32_t reserved0         :12;
                __volatile__ uint32_t rot_mod_l1            :3;
                __volatile__ uint32_t ck_en_l1          :1;
                __volatile__ uint32_t pallet_en_l1      :1;
                __volatile__ uint32_t reserved1         :11;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_layer1_cfg_u;
        ...
        union _GSP_LAYER1_Y_ADDR_TAG//0x0064
        {
            ...
            {
                __volatile__ uint32_t y_base_addr_l1        :32;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_layer1_y_addr_u;
        ...
        union _GSP_LAYER1_UV_ADDR_TAG//0x0068
        {
            ...
            {
                __volatile__ uint32_t uv_base_addr_l1          :32;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER1_VA_ADDR_TAG//0x006c
        {
            ...
            {
                __volatile__ uint32_t va_base_addr_l1          :32;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER1_PITCH_TAG//0x0070
        {
            ...
            {
                __volatile__ uint32_t pitch1                :12;
                __volatile__ uint32_t reserved_unpred       :20;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        } gsp_layer1_pitch_u;
        ...
        union _GSP_LAYER1_CLIP_START_TAG//0x0074
        {
            ...
            {
                __volatile__ uint32_t clip_start_x_l1       :12;
                __volatile__ uint32_t reserved0         :4;
                __volatile__ uint32_t clip_start_y_l1       :12;
                __volatile__ uint32_t reserved1         :4;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER1_CLIP_SIZE_TAG//0x0078
        {
            ...
            {
                __volatile__ uint32_t clip_size_x_l1        :12;
                __volatile__ uint32_t reserved0         :4;
                __volatile__ uint32_t clip_size_y_l1        :12;
                __volatile__ uint32_t reserved1         :4;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER1_DES_START_TAG//0x007c
        {
            ...
            {
                __volatile__ uint32_t des_start_x_l1        :12;
                __volatile__ uint32_t reserved0         :4;
                __volatile__ uint32_t des_start_y_l1        :12;
                __volatile__ uint32_t reserved1         :4;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER1_GREY_RGB_TAG//0x0080
        {
            ...
            {
                __volatile__ uint32_t grey_b_l1         :8;
                __volatile__ uint32_t grey_g_l1         :8;
                __volatile__ uint32_t grey_r_l1         :8;
                __volatile__ uint32_t reserved          :8;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER1_ENDIAN_TAG//0x0084
        {
            ...
            {
                __volatile__ uint32_t y_endian_mod_l1       :3;
                __volatile__ uint32_t uv_endian_mod_l1  :3;
                __volatile__ uint32_t va_endian_mod_l1  :3;
                __volatile__ uint32_t rgb_swap_mod_l1       :3;
                __volatile__ uint32_t a_swap_mod_l1     :1;
                __volatile__ uint32_t reserved          :19;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER1_ALPHA_TAG//0x0088
        {
            ...
            {
                __volatile__ uint32_t alpha_l1          :8;
                __volatile__ uint32_t reserved          :24;
            }
            mBits;
            __volatile__ uint32_t dwValue;
        ...
        union _GSP_LAYER1_CK_TAG//0x008c
        {
            ...
            {
                __volatile__ uint32_t ck_b_l1           :8;
                __volatile__ uint32_t ck_g_l1           :8;
                __volatile__ uint32_t ck_r_l1           :8;
                __volatile__ uint32_t reserved      :8;
            }
            mBits;
            __volatile__ uint32_t dwValue;
